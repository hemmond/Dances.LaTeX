...
\newcommand{\authorname}{Tomáš \uv{Hemmond} Látal}    % Primary author (mandatory)
\newcommand{\booktitle}{Irské Archivní Ceilí Tance}      % Main title (mandatory)
\newcommand{\subtitle}{Folcon 2026}             % Subtitle (optional)
...
\newcommand{\editionyear}{2026}                 % Edition year for print run (optional)
...
%     \inputdance{content/irish_ceili_dances/antrim_reel}             % OK
%     \inputdance{content/irish_ceili_dances/bohreen_dance}
%     \inputdance{content/irish_ceili_dances/bonfire_dance}
%     \inputdance{content/irish_ceili_dances/the_bridge_of_athlone}   % WIP
%     \inputdance{content/irish_ceili_dances/denis_murphys_reel}
%     \inputdance{content/irish_ceili_dances/the_divided_dance}
%     \inputdance{content/irish_ceili_dances/every_mans_chance}
    \inputdance{content/irish_ceili_dances/fairy_reel_okeeffe1914}
    \inputdance{content/irish_ceili_dances/fairy_reel_burchenal1929}
    \inputdance{content/irish_ceili_dances/fairy_reel_orpen1931}
    \inputdance{content/irish_ceili_dances/fairy_reel_orafferty1934}
    \inputdance{content/irish_ceili_dances/fairy_reel}
%     \inputdance{content/irish_ceili_dances/folcon_diagonal_reel}    % OK
%     \inputdance{content/irish_ceili_dances/galway_reel}
%     \inputdance{content/irish_ceili_dances/glassdrummond_reel}
%     \inputdance{content/irish_ceili_dances/glencar_reel}
%     \inputdance{content/irish_ceili_dances/harvest_time_jig}
%     \inputdance{content/irish_ceili_dances/haste_to_the_wedding}    % Bug
%     \inputdance{content/irish_ceili_dances/hooks_and_eyes}          % OK
%     \inputdance{content/irish_ceili_dances/midsummer_reel}
%     \inputdance{content/irish_ceili_dances/the_mountain_top}
%     \inputdance{content/irish_ceili_dances/petticoat_swish}
%     \inputdance{content/irish_ceili_dances/the_rakes_of_mallow}
%     \inputdance{content/irish_ceili_dances/rince_fada}              % OK
%     \inputdance{content/irish_ceili_dances/the_siege_of_carrick}
%     \inputdance{content/irish_ceili_dances/shower_polka}            % OK
%     \inputdance{content/irish_ceili_dances/siege_of_ennis}
%     \inputdance{content/irish_ceili_dances/strasperry_reel}
    \inputdance{content/irish_ceili_dances/the_walls_of_limmerick_okeeffe1914}
    \inputdance{content/irish_ceili_dances/the_walls_of_limmerick_burchenal1929}
    \inputdance{content/irish_ceili_dances/the_walls_of_limmerick_orafferty1934}
...
%     Irské Archivní Ceilí Tance © 2026 by Tomáš Látal is licensed under CC BY 4.0. To view a~copy of this license, visit https://creativecommons.org/licenses/by/4.0/
% }
